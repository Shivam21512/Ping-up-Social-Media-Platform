        ...
        <div className='w-full max-w-md'>
            ...
            relative' style={{backgroundColor:background}}>
                {
                    mode === 'text' && (
                        ...
                        p-6 text-lg resize-none focus:outlie-none' placeholder="What's on your mind?"
            ...
            <div className='flex gap-2 mt-4'>
                <button onClick={() => {setMode('text'); setMedia(null); setPreviewUrl(null)}}
                    className={`flex-1 flex cursor-pointer items-center justify-center gap-2 p-2
            ...
            p-3 mt-4 w-full rounded bg-gradient-to-r from bg-indigo-500 to-purple-600
