...
const UserProfileInfo = ({user, posts, profileId, setShowEdit}) => {
  ...
  return (
    <div className='relative py-4 px-6 md:px-8 bg-white'>
        <div className='flex flex-col nd:flex-row items-start gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className='flex flex-col md:flex-row items-start justify-between'>
                    ...
                    {/* If user is not on other profile that means he is opening
                    his profile so we will give edit button */}
                    {
                        !profileId &&
                        <button onClick={()=> setShowEdit(true)} className='flex items-center
                        gap-2 border border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg
                        font-medium cursor-pointer transition-colors mt-4 md:mt-0'>
