...
const StoryViewer = ({viewStory, setViewStory}) => {
        ...
        switch (viewStory.media_type) {
            ...
            case 'video':
                return(
                    ...
                    className='max-h-screen' controls autoPlay></video>
                );
            case 'text':
                return(
  ...
  return (
    ...
    items-center justify-center' style={{backgroundColor:viewStory.media_type === 'text' ?
        ...
        {/* User Info - Top Left */}
        <div className='absolute top-4 left-4 flex item-center space-x-3 p-2 px-4
        sm:p-4 sm:px-8 backdrop-blur-2xl rounded bg-black/50'>
            ...
            rounded-full object-cover border border-white '></img>
