...
const Login = () => {
  return (
    <div className='min-h-screen flex flex-col md:flex-row'>
        ...
        {/* Background Image */}
        <img src={assets.bgImage} alt='' className='absolute top-0 left-0 -z-1 
        ...
        lg:pl-40'>
            ...
            <div>
                <div className='flex itesm-center gap-3 mb-4 max-mb:mt-10'>
                    <img src={assets.group_users} alt='' className='h-8 md:h-10'></img>
                    <div>
                        <div className='flex'>
                            {Array(5).fill(0).map((_, i)=>(
                                <Star key={i} className='size-4 md:size-4.5 text-transparent
                                fill-amber-500'/>
                            ))}
                        </div>
                        <p>Used by 11k+ developers</p>
                    </div>
                </div>
