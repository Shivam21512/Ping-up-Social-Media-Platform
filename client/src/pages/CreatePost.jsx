...
const CreatePost = () => {
  ...
  const postType =
    images.length && content ? "text_with_image" :
  ...
  try {
    ...
    images.forEach((image) => {
      formData.append("images", image);   // ✅ must match backend
    });
  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        {/* Form */}
        <div className='max-w-xl bg-white p-4 sm:p-8 rounded-xl shadow-md
        space-y-4'>
           
          {/* Header */}
          <div className='flex items-center gap-3'>
            <img src={user.profile_picture} alt='' className='w-12 h-12
            rounded-full shadow'></img>
            <div>
          ...
          {/* Text Area */}
          <textarea className='w-full resize-noone max-h-20 mt-4 text-sm
